...
class Application:
    ...
    def __init__(self):
        ...
        self.root.geometry("950x700")  # Reduced window size

        # --- Video feed panel ---
        self.panel = tk.Label(self.root)
        self.panel.place(x=50, y=10, width=420, height=480)

        # --- Predicted sign image ---
        self.panel2 = tk.Label(self.root)
        self.panel2.place(x=700, y=200, width=400, height=300)
        ...
        self.panel3 = tk.Label(self.root, font=("Courier", 18))
        self.panel3.place(x=160, y=500)

        # --- Sentence ---
        self.T3 = tk.Label(self.root, text="Sentence :", font=("Courier", 18, "bold"))
        self.T3.place(x=10, y=500)

        self.panel5 = tk.Label(self.root, font=("Courier", 16))
        self.panel5.place(x=140, y=500)

        # --- Suggestions ---
        self.T4 = tk.Label(self.root, text="Suggestions :", fg="red",
                           font=("Courier", 18, "bold"))
        self.T4.place(x=10, y=600)

        # --- Suggestion Buttons ---
        self.b1 = tk.Button(self.root, text="", width=10, font=("Courier", 14))
        self.b1.place(x=150, y=600)

        self.b2 = tk.Button(self.root, text="", width=10, font=("Courier", 14))
        self.b2.place(x=300, y=600)

        self.b3 = tk.Button(self.root, text="", width=10, font=("Courier", 14))
        self.b3.place(x=450, y=600)

        self.b4 = tk.Button(self.root, text="", width=10, font=("Courier", 14))
        self.b4.place(x=600, y=600)

        # --- Speak and Clear Buttons ---
        self.speak = tk.Button(self.root, text="Speak", font=("Courier", 16),
                               width=8, command=self.speak_fun)
        self.speak.place(x=700, y=500)

        self.clear = tk.Button(self.root, text="Clear", font=("Courier", 16),
                               width=8, command=self.clear_fun)
    ...
    def video_loop(self):
        try:
            ok, frame = self.vs.read()  # Remove argument (0), it should be just read()
            ...
            if hands[0]:
                ...
                white = cv2.imread("C:\\Users\\HP\\OneDrive\\Desktop\\STS\\sign to Speech wordp preditStanly\\white.jpg")
