...
cv2.imwrite("D:\\refeerance\\Sign-Language-To-Text-and-Speech-Conversion-master\\white.jpg", white)
...
while True:
    try:
        ...
        if hands:
            ...
            white = cv2.imread("D:\\refeerance\\Sign-Language-To-Text-and-Speech-Conversion-master\\white.jpg")
